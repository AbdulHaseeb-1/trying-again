...
import { EmptyState, FilterChips, MarketRow } from '@/components/market-ui';
import { Tap } from '@/components/tap';
import { ThemedText } from '@/components/themed-text';
import { alertSeed, marketAssets } from '@/data/market';
...
const styles = StyleSheet.create({
  ...
  watchList: { borderRadius: Radius.lg, borderWidth: StyleSheet.hairlineWidth, paddingHorizontal: Spacing.four },
